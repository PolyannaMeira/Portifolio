...
const About = () => {
	return (
		<AboutContainer id="sobre">
            ...
            <AboutText>If you’re looking for someone who brings
						empathy, dedication, and a passion for creating meaningful
						solutions, let’s build something great together!
					</AboutText>
					<ButtonGroup>
						<PrimaryButton as="a" href="/cv.pdf" download>Download CV</PrimaryButton>
						<SecondaryButton as="a" href="mailto:polyannaxam@gmail.com">Contact</SecondaryButton>
					</ButtonGroup>
				</AboutInfo>
				<ProfileImageContainer>
					<ProfileImage>
						<ProfileImageInner>
							<img src={Foto} alt="Foto de Polyanna Meira" style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: "inherit" }} />
						</ProfileImageInner>
					</ProfileImage>
				</ProfileImageContainer>
			</AboutContent>
